namespace Wizualizer.ModeleDrzwi.Wiener;

public class Wiener1 : Drzwi
{
    ...
    public Wiener1(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
