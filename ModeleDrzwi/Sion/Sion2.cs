namespace Wizualizer.ModeleDrzwi.Sion;

public class Sion2 : Drzwi
{
    ...
    public Sion2(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxZewSzerokośćStronaPrzylgowa = Skrzydło.SzerokośćWPrzyldze - ParametrOtworu + (Skrzydło.SzerokośćWPrzyldze - OtwórSzerokość) / 2 + 32.5d - OdsunięcieOdOsi - OdległośćInoxOdKrawędziStronaPrzylgowa;
        ...
        InoxZewSzerokośćStronaFelcowa = Skrzydło.SzerokośćWPrzyldze - ParametrOtworu + (Skrzydło.SzerokośćWPrzyldze - OtwórSzerokość) / 2 + 32.5d - OdsunięcieOdOsi - OdległośćInoxOdKrawędziStronaFelcowa - PrzylgaBoczna;
    ...
    protected override void RysujInox()
    {
        ...
        double odsunięcieInoxOdKrawędziY = (Skrzydło.WysokośćWPrzyldze - 1050) / 3d;
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            paths[i] = new()
            {
                ...
                Margin = new Thickness(odsunięcieInoxOdKrawędziX * SkalaParametr, 0d, 0d, ((i + 2) * odsunięcieInoxOdKrawędziY + 600 - InoxZewWysokośćStronaPrzylgowa / 2) * SkalaParametr)
            };
            if (ZewIsTrue == false)
            {
    ...
    protected override void RysujSzkło()
    {
        ...
        double odsunięcieSzkłoOdKrawędziY = (Skrzydło.WysokośćWPrzyldze - 1050) / 3d;
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            paths[i] = new()
            {
                ...
                VerticalAlignment = VerticalAlignment.Bottom,
                HorizontalAlignment = HorizontalAlignment.Left,
                Margin = new Thickness(odsunięcieSzkłoOdKrawędziX * SkalaParametr, 0d, 0d, ((i + 2) * odsunięcieSzkłoOdKrawędziY + 600 - SzkłoWysokość / 2) * SkalaParametr)
            };
