...
public class Wels6 : Drzwi
{
    ...
    public Wels6(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujInox()
    {
        ...
        for (int i = 0; i < pathPaskiInox.Length; i++)
        {
            pathPaskiInox[i] = new()
            {
                ...
                VerticalAlignment = VerticalAlignment.Bottom,
                HorizontalAlignment = HorizontalAlignment.Left,
                Margin = new Thickness((odsunięciePaskiInoxOdKrawędziX - (i + 1) * (PasekInoxSzerokość + PasekInoxOdsunięcie)) * SkalaParametr, 0d, 0d, odsunięciePaskiInoxOdKrawędziY * SkalaParametr)
            };
