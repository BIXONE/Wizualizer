namespace Wizualizer.ModeleDrzwi.Wels;

public class Wels5 : Drzwi
{
    ...
    public Wels5(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujInox()
    {
        ...
        Path[] pathPaskiInox = new Path[4];
        double odsunięciePaskiInoxOdKrawędziX = odsunięcieInoxOdKrawędziX;
        ...
        for (int i = 0; i < pathPaskiInox.Length; i++)
        {
            ...
            if (i == 0)
                pathPaskiInox[i].Margin = new Thickness((odsunięciePaskiInoxOdKrawędziX - 2 * (PasekInoxSzerokość + PasekInoxOdsunięcie)) * SkalaParametr, 0d, 0d, odsunięciePaskiInoxOdKrawędziY * SkalaParametr);
            else if (i == 1)
                pathPaskiInox[i].Margin = new Thickness((odsunięciePaskiInoxOdKrawędziX - 1 * (PasekInoxSzerokość + PasekInoxOdsunięcie)) * SkalaParametr, 0d, 0d, odsunięciePaskiInoxOdKrawędziY * SkalaParametr);
            else if (i == 2)
                pathPaskiInox[i].Margin = new Thickness((odsunięciePaskiInoxOdKrawędziX + PasekInoxOdsunięcie + InoxZewSzerokośćStronaPrzylgowa) * SkalaParametr, 0d, 0d, odsunięciePaskiInoxOdKrawędziY * SkalaParametr);
            else if (i == 3)
                pathPaskiInox[i].Margin = new Thickness((odsunięciePaskiInoxOdKrawędziX + PasekInoxSzerokość + 2 * PasekInoxOdsunięcie + InoxZewSzerokośćStronaPrzylgowa) * SkalaParametr, 0d, 0d, odsunięciePaskiInoxOdKrawędziY * SkalaParametr);
