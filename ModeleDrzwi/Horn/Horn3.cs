...
public class Horn3 : Drzwi
{
    ...
    public Horn3(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        OdsunięcieOdOsi = Skrzydło.SzerokośćWPrzyldze - 260;
        OtwórSzerokość = 80;
        OtwórZaokrąglenie = 8;
