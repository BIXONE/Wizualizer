...
public class Langen3 : Drzwi
{
    ...
    public Langen3(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxZewSzerokośćStronaPrzylgowa = OtwórSzerokość + 2 * 50;
