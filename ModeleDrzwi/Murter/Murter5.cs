...
public class Murter5 : Drzwi
{
    ...
    public Murter5(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujSzkło()
    {
        Path paths;
        Grid grid = new();
        double odsunięcieSzkłoOdKrawędziX = 302.5d - SzkłoSzerokość / 2d;
