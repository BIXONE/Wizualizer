namespace Wizualizer.ModeleDrzwi.Linden;

public class Linden6 : Drzwi
{
    ...
    protected double OdległośćMiędzyOtworamiInox { get; set; }
    ...
    public Linden6(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        double WirtualnyOtwórPierwszy = 80d;
        OdległośćMiędzyOtworamiInox = 35d;
        ...
        InoxWewSzerokośćStronaPrzylgowa = WirtualnyOtwórPierwszy - 2d * 15d;
        ...
        PasekInoxSzerokość = 15d;
        PasekInoxWysokość = InoxZewWysokośćStronaPrzylgowa;
        ...
        InoxGeometriaStronaPrzylgowa = new(
            ...
            new Prostokąt(InoxWewSzerokośćStronaPrzylgowa, InoxWewWysokośćStronaPrzylgowa, PraweIsTrue, InoxWewZaokrąglenieStronaPrzylgowa, OdsunięcieInoxWewWzględemOsiXStronaPrzylgowa + InoxWewSzerokośćStronaPrzylgowa + OdległośćMiędzyOtworamiInox, OdsunięcieInoxWewWzględemOsiYStronaPrzylgowa),
            PraweIsTrue, nazwaModelu: NazwaModelu);
        InoxGeometriaStronaPrzylgowa = new(
            InoxGeometriaStronaPrzylgowa,
            new Prostokąt(InoxWewSzerokośćStronaPrzylgowa, InoxWewWysokośćStronaPrzylgowa, PraweIsTrue, InoxWewZaokrąglenieStronaPrzylgowa, OdsunięcieInoxWewWzględemOsiXStronaPrzylgowa + 2 * (InoxWewSzerokośćStronaPrzylgowa + OdległośćMiędzyOtworamiInox), OdsunięcieInoxWewWzględemOsiYStronaPrzylgowa),
            PraweIsTrue, nazwaModelu: NazwaModelu);
        ...
        InoxGeometriaStronaFelcowa = new(
            ...
            new Prostokąt(InoxWewSzerokośćStronaFelcowa, InoxWewWysokośćStronaFelcowa, !PraweIsTrue, InoxWewZaokrąglenieStronaFelcowa, OdsunięcieInoxWewWzględemOsiXStronaFelcowa + InoxWewSzerokośćStronaFelcowa + OdległośćMiędzyOtworamiInox, OdsunięcieInoxWewWzględemOsiYStronaFelcowa),
            !PraweIsTrue, nazwaModelu: NazwaModelu);
        InoxGeometriaStronaFelcowa = new(
            InoxGeometriaStronaFelcowa,
            new Prostokąt(InoxWewSzerokośćStronaFelcowa, InoxWewWysokośćStronaFelcowa, !PraweIsTrue, InoxWewZaokrąglenieStronaFelcowa, OdsunięcieInoxWewWzględemOsiXStronaFelcowa + 2 * (InoxWewSzerokośćStronaFelcowa + OdległośćMiędzyOtworamiInox), OdsunięcieInoxWewWzględemOsiYStronaFelcowa),
            !PraweIsTrue, nazwaModelu: NazwaModelu);
    ...
    protected override void RysujInox()
    {
        Path paths;
        Grid grid = new();
        double odsunięcieInoxOdKrawędziX = 260d - InoxWewSzerokośćStronaPrzylgowa / 2 - 35d;
        ...
        double odsunięciePaskiInoxOdKrawędziX = 200d + InoxZewSzerokośćStronaPrzylgowa + PasekInoxOdsunięcie;
        ...
        for (int i = 0; i < pathPaskiInox.Length; i++)
        {
            pathPaskiInox[i] = new()
            {
                ...
                VerticalAlignment = VerticalAlignment.Bottom,
                HorizontalAlignment = HorizontalAlignment.Left,
                Margin = new Thickness((odsunięciePaskiInoxOdKrawędziX + i * (PasekInoxSzerokość + PasekInoxOdsunięcie)) * SkalaParametr, 0d, 0d, odsunięciePaskiInoxOdKrawędziY * SkalaParametr)
            };
    ...
    protected override void RysujSzkło()
    {
        Path paths;
        Grid grid = new();
        double odsunięcieSzkłoOdKrawędziX = 345d - SzkłoSzerokość / 2d;
