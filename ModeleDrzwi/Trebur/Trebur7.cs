...
public class Trebur7 : Drzwi
{
    ...
    public Trebur7(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujInox()
    {
        Path pathInox;
        Grid grid = new();
        double odsunięcieInoxOdKrawędziX = 260d - InoxZewSzerokośćStronaPrzylgowa / 2d;
        ...
        double odsunięciePaskiInoxOdKrawędziX = 260d + InoxZewSzerokośćStronaPrzylgowa / 2d + PasekInoxOdsunięcie;
