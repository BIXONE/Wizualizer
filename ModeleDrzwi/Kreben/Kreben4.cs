...
public class Kreben4 : Drzwi
{
    ...
    public Kreben4(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxZewSzerokośćStronaPrzylgowa = OtwórSzerokość + 2 * 20 + 144;
        ...
        InoxGeometriaStronaPrzylgowa = new(new ProstokątZPaskamiBocznymi(
            ...
            new WąskiPasekDoProstokąta(0d, 0d, 0d, 0d),
        ...
        InoxTekstura = new(InoxKolor, InoxZewSzerokośćStronaPrzylgowa + PasekInoxSzerokośćStronaPrzylgowa, InoxZewWysokośćStronaPrzylgowa, SkalaParametr);
    ...
    protected override void RysujInox()
    {
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            paths[i] = new()
            {
                ...
                Width = (InoxZewSzerokośćStronaPrzylgowa + PasekInoxSzerokośćStronaPrzylgowa) * SkalaParametr,
            ...
            if (ZewIsTrue == false)
            {
                ...
                paths[i].Width = (InoxZewSzerokośćStronaFelcowa + PasekInoxSzerokośćStronaFelcowa) * SkalaParametr;
            }
            //// Sam szkielet
