...
public class Leimen1 : Drzwi
{
    ...
    public Leimen1(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        double OdsunięcieInoxWewWzględemOsiXStronaPrzylgowa2 = InoxZewSzerokośćStronaPrzylgowa - OdsunięcieInoxWewWzględemOsiXStronaPrzylgowa - InoxWewSzerokośćStronaPrzylgowa ;
        double OdsunięcieInoxWewWzględemOsiXStronaFelcowa2 = InoxZewSzerokośćStronaFelcowa - OdsunięcieInoxWewWzględemOsiXStronaFelcowa - InoxWewSzerokośćStronaFelcowa;
