...
public class Leimen2 : Drzwi
{
    protected double[] OdsunięcieOdOsi { get; set; } = new double[2];
    ...
    public Leimen2(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        OdsunięcieOdOsi[0] = 260;
        OdsunięcieOdOsi[1] = 415;
    ...
    protected override void RysujInox()
    {
        ...
        Grid grid = new();
        double odsunięcieInoxOdKrawędziX;
        double odsunięcieInoxOdKrawędziY = OdległośćInoxOdKrawędziStronaPrzylgowa;

        for (int i = 0; i < paths.Length; i++)
        {
            odsunięcieInoxOdKrawędziX = OdsunięcieOdOsi[i] - InoxZewSzerokośćStronaPrzylgowa / 2;
    ...
    protected override void RysujSzkło()
    {
        Path[] paths = new Path[2];
        Grid grid = new();
        double odsunięcieSzkłoOdKrawędziX;
        double odsunięcieSzkłoOdKrawędziY = (Skrzydło.WysokośćWPrzyldze - SzkłoWysokość) / 2;

        for (int i = 0; i < paths.Length; i++)
        {
            odsunięcieSzkłoOdKrawędziX = OdsunięcieOdOsi[i] - SzkłoSzerokość / 2;
