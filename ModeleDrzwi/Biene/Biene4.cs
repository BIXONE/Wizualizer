namespace Wizualizer.ModeleDrzwi.Biene;

public class Biene4 : Drzwi
{
    ...
    public Biene4(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxZewSzerokośćStronaPrzylgowa = Skrzydło.SzerokośćWPrzyldze - 200 * 2;
    ...
    protected override void RysujInox()
    {
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            ...
            paths[i] = new()
            {
                ...
                Margin = new Thickness(odsunięcieInoxOdKrawędziX * SkalaParametr, 0d, 0d, (i * odsunięcieInoxOdKrawędziY + (Skrzydło.WysokośćWPrzyldze - 5 * RoztawPasków) / 2d - InoxZewWysokośćStronaPrzylgowa / 2) * SkalaParametr)
            };
            if (ZewIsTrue == false)
            {
