...
public class Biene2 : Drzwi
{
    ...
    public Biene2(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxZewSzerokośćStronaPrzylgowa = Skrzydło.SzerokośćWPrzyldze - 100 * 2;
