...
public class Amberg3 : Drzwi
{
    ...
    public Amberg3(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujSzkło()
    {
        ...
        Grid grid = new();
        double odsunięcieSzybyOdKrawędziX = 315d - SzkłoSzerokość / 2d;
