...
public class Amberg4 : Drzwi
{
    ...
    public Amberg4(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujSzkło()
    {
        ...
        Grid grid = new();
        double odsunięcieSzybyOdKrawędziX = 295d - SzkłoSzerokość / 2d;
