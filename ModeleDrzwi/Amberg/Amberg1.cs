...
public class Amberg1 : Drzwi
{
    ...
    public Amberg1(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujSzkło()
    {
        ...
        Grid grid = new();
        double odsunięcieSzybyOdKrawędziX = 435d - SzkłoSzerokość / 2d;
