...
public class Leoben1 : Drzwi
{
    ...
    public Leoben1(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujInox()
    {
        ...
        double odsunięcieInoxOdKrawędziY = Skrzydło.WysokośćWPrzyldze * 0.6;
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            paths[i] = new()
            {
                ...
                Margin = new Thickness(odsunięcieInoxOdKrawędziX * SkalaParametr, 0d, 0d, (odsunięcieInoxOdKrawędziY + (i - 1) * 300d - InoxZewWysokośćStronaPrzylgowa / 2) * SkalaParametr)
            };
            if (ZewIsTrue == false)
            {
    ...
    protected override void RysujSzkło()
    {
        ...
        double odsunięcieSzkłoOdKrawędziY = Skrzydło.WysokośćWPrzyldze * 0.6;
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            ...
            VerticalAlignment = VerticalAlignment.Bottom,
            HorizontalAlignment = HorizontalAlignment.Left,
            Margin = new Thickness(odsunięcieSzkłoOdKrawędziX * SkalaParametr, 0d, 0d, (odsunięcieSzkłoOdKrawędziY + (i - 1) * 300d - SzkłoWysokość / 2) * SkalaParametr)
            };
