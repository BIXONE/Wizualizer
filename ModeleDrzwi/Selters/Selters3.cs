...
public class Selters3 : Drzwi
{
    ...
    protected double InoxWewSzerokość2 { get; set; }
    protected double InoxWewWysokość2 { get; set; }
    protected double InoxWewZaokrąglenie2 { get; set; }
    ...
    public Selters3(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxWewWysokość1 = 245;
        InoxWewZaokrąglenie1 = 0;

        InoxWewSzerokość2 = OtwórSzerokość - 2d * 15d;
        InoxWewWysokość2 = 735;
        InoxWewZaokrąglenie2 = 0;
        ...
        for (int i = 1; i < 23; i++)
        {
            ...
            if (i == 9)
            {
                InoxGeometriaStronaPrzylgowa = new(InoxGeometriaStronaPrzylgowa, new Prostokąt(InoxWewSzerokość2, InoxWewWysokość2, PraweIsTrue, InoxWewZaokrąglenie2, OdsunięcieInoxWewWzględemOsiXStronaPrzylgowa, i * 70 + OdsunięcieInoxWewWzględemOsiYStronaPrzylgowa), PraweIsTrue, nazwaModelu: NazwaModelu);
                InoxGeometriaStronaFelcowa = new(InoxGeometriaStronaFelcowa, new Prostokąt(InoxWewSzerokość2, InoxWewWysokość2, !PraweIsTrue, InoxWewZaokrąglenie2, OdsunięcieInoxWewWzględemOsiXStronaFelcowa, i * 70 + OdsunięcieInoxWewWzględemOsiYStronaFelcowa), !PraweIsTrue, nazwaModelu: NazwaModelu);
                i = 20;
            }
