...
public class Roding2 : Drzwi
{
    ...
    public Roding2(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected void GeometriaModelu()
    {
        ...
        InoxZewWysokośćStronaPrzylgowa = OtwórWysokość + 2 * 20d;
