namespace Wizualizer.ModeleDrzwi.Roding;

public class Roding3 : Drzwi
{
    ...
    public Roding3(Ościeżnica ościeżnica, Skrzydło skrzydło, SzyldDolny szyldDolny, Klamka klamka, SzyldGórny szyldGórny,
    ...
    protected override void RysujInox()
    {
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            paths[i] = new()
            {
                ...
                Margin = new Thickness(odsunięcieInoxOdKrawędziX * SkalaParametr, 0d, 0d, ((i + 1) * odsunięcieInoxOdKrawędziY + 300d - InoxZewWysokośćStronaPrzylgowa / 2) * SkalaParametr)
            };
    ...
    protected override void RysujSzkło()
    {
        ...
        for (int i = 0; i < paths.Length; i++)
        {
            paths[i] = new()
            {
                ...
                VerticalAlignment = VerticalAlignment.Bottom,
                HorizontalAlignment = HorizontalAlignment.Left,
                Margin = new Thickness(odsunięcieSzkłoOdKrawędziX * SkalaParametr, 0d, 0d, ((i + 1) * odsunięcieSzkłoOdKrawędziY + 300 - SzkłoWysokość / 2) * SkalaParametr)
            };
